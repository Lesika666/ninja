...
class AccountController extends BaseController
{
    ...
    private function showInvoiceDesign($section)
    {
        ...
        if ($invoice = Invoice::scope()->invoices()->orderBy('id')->first()) {
            // Addition (Dylan) : payments data to the sample invoice
            $invoice->load('account', 'client.contacts', 'invoice_items', 'payments');
            ...
            // Addition (Dylan) : payment object filled
            $payment->created_at = Utils::fromSqlDate(date('Y-m-d'));
            ...
            // Addition (Dylan) : Added payments line to invoice object
