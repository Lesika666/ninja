    ...
    public function columns()
    {
        return [
            ...
            */
            ...
            // Removed (Dylan) : Replaced by next_due_date below
//            [
//                'private_notes',
//                function ($model) {
...
//                },
//            ],
            // Addition (Dylan) : Display the next due date
//            [
//                'next_due_date',
//                function ($model) {
//                    $last_sent_date = DateTime::createFromFormat('Y-m-d', $model->last_sent_date_sql);
//                    $last_sent_date->add(date_interval_create_from_date_string($model->date_interval));
//                    return $last_sent_date->format('d.m.Y');
//                },
//            ],
            [
                'status',
