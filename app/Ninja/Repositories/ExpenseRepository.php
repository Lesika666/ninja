...
class ExpenseRepository extends BaseRepository
{
    ...
    {
        return Expense::whereBetween('expense_date', [$start_of_month,$end_of_month])->get();
    }

    /**
     * Addition (Dylan) : Get yearly expense total amount
     *
     * @param $year
     * @return false|string|null
     */
    public function getYearlyExpenseTotal($year)
    {
        return Expense::whereBetween('expense_date', ["$year-01-01","$year-12-31"])->sum('amount');;
    }
}
