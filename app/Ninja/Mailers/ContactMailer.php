...
class ContactMailer extends Mailer
{
    ...
    private function sendInvitation(
        ...
        // Addition (Dylan) : add quote management for fromEmail
        $isQuote = $invoice->invoice_type_id == 2;

        $subject = $this->templateService->processVariables($subject, $variables);
//        Addition (Dylan) : Change proposal email
        $fromEmail = $isQuote ? 'remi@rgdesign.fr' : $account->getReplyToEmail() ?: $user->email;
