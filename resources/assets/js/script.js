...
function getInvoiceItemsTable(invoice) {
    let html = '';
    let invoice_items = invoice.invoice_items;
    let invoice_total = 0;

    html += '<table class="w-100 font-size-14 quote-pricing-header"><tbody><tr>';

    // Table head row
    html += '<td class="w-19 font-size-14 padding-right-10 padding-left-5 padding-top-5 padding-bottom-5"><div><b>Article</b></div></td>';
    html += '<td class="w-35 font-size-14 padding-right-10 padding-left-5 padding-top-5 padding-bottom-5"><div><b>Description</b></div></td>';
    html += '<td class="w-17 font-size-14 text-right padding-left-10 padding-right-5 padding-top-5 padding-bottom-5"><div><b>Cout unitaire</b></div></td>';
    html += '<td class="w-12 font-size-14 text-right padding-left-10 padding-right-5 padding-top-5 padding-bottom-5"><div><b>Quantité</b></div></td>';
    html += '<td class="w-17 font-size-14 text-right padding-left-10 padding-right-5 padding-top-5 padding-bottom-5"><div><b>Total</b></div></td>';
    ...
    for (let i = 0; i < invoice_items.length; i++) {
        let cost = parseFloat(invoice_items[i].cost).toFixed(2);
        let qty = parseFloat(invoice_items[i].qty);
        let subtotal = qty * cost;

        // Item row
        html += '<table class="w-100 font-size-14 quote-pricing"><tbody><tr>';
        html += '<td class="w-19 font-size-14 rg-color padding-right-10 padding-left-5 padding-top-5 padding-bottom-5"><div><b>'+invoice_items[i].product_key+'</b></div></td>';
        html += '<td class="w-35 font-size-14 padding-right-10 padding-left-5 padding-top-5 padding-bottom-5">';
        let description = invoice_items[i].notes.split("\r\n");
        for (let j = 0; j < description.length; j++) {
            html += '<div>'+description[j]+'</div>';
        }
        html += '</td>';
        html += '<td class="w-17 font-size-14 text-right padding-left-10 padding-right-5 padding-top-5 padding-bottom-5"><div>'+cost+'€</div></td>';
        html += '<td class="w-12 font-size-14 text-right padding-left-10 padding-right-5 padding-top-5 padding-bottom-5"><div>'+qty+'</div></td>';
        html += '<td class="w-17 font-size-14 text-right padding-left-10 padding-right-5 padding-top-5 padding-bottom-5"><div>'+subtotal.toFixed(2)+'€</div></td>';
        html += '</tr></tbody></table>';

        total += subtotal
    }
    // Total row
    html += '<table class="w-100 font-size-14 padding-top-5 padding-left-5 padding-right-5 padding-bottom-5 quote-pricing-footer"><tbody><tr><td class="text-right" colspan="5"><div><b>Total (HT) : '+total.toFixed(2)+'€</b></div></td></tr></tbody></table>';
    html += '<table class="w-100 font-size-14 padding-top-5 padding-left-5 padding-right-5 padding-bottom-5"><tbody><tr><td class="text-right" colspan="5"><div>Total (TTC) : '+invoice.amount+'€</div></td></tr></tbody></table>';
