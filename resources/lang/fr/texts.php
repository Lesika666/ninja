...
<ul><li>Marges de crédit et affacturage d\'affaires flexibles.</li></ul>',
    ...
    // Addition (Dylan) : Add some strings to translate
    'no_payments' => 'Aucun paiement',
    'commitment_period_from' => 'Engagement du',
    'commitment_period' => 'Période d\'engagement',
    'covered_period' => 'Période couverte',
    'covered_period_end_date' => 'Fin de la période couverte',
    'edit_invoice_client' => 'Modifier le client de la facture',
    'past_due_and_seen' => 'En retard + Vu',
    'next_due_date' => 'Prochaine échéance',
    'definitely_delete_invoice' => 'Supprimer la facture définitivement',
    'treasury' => 'Trésorerie',
    'upcoming_recurring_invoices' => 'Factures récurrentes à venir',
    'next_sent' => 'Prochain envoi',
    'previous_year' => 'Année N-1',
    'left_to_pay' => 'Reste à payer',
    'ca_no_recurring_N-1' => 'CA Non récurrent (N-1)',
    'ca_recurring_N-1' => 'CA Récurrent (N-1)',
    'ca_recurring' => 'CA récurrent',
    'ca_no_recurring' => 'CA Non récurrent',
    'ca_old_clients_N-1' => 'CA Ancien clients (N-1)',
    'ca_new_clients_N-1' => 'CA Nouveaux clients (N-1)',
    'ca_old_clients' => 'CA Anciens clients',
    'ca_new_clients' => 'CA Nouveaux clients',
);
